...
@property(nonatomic,strong) UIView *imageBgView_1;
@property(nonatomic,strong) UIView *imageBgView_2;
...
- (void)viewDidLoad {
    ...
    labelBgView.frame = CGRectMake(SPACE_TWENTY, RATIO_H(100), SCREEN_W - RATIO_H(40), RATIO_H(30));
    [self.view addSubview:labelBgView];
    self.labelBgView = labelBgView;
    
    UIView *imageBgView_1 = [[UIView alloc] init];
    imageBgView_1.frame = CGRectMake(RATIO_H(100), SPACE_TEN + 1 * (RATIO_H(150) + SPACE_TEN), RATIO_H(100), RATIO_H(100));
    [self.view addSubview:imageBgView_1];
    self.imageBgView_1 = imageBgView_1;
    
    UIView *imageBgView_2 = [[UIView alloc] init];
    imageBgView_2.frame = CGRectMake(RATIO_H(100), SPACE_TEN + 2 * (RATIO_H(150) + SPACE_TEN), RATIO_H(100), RATIO_H(100));
    [self.view addSubview:imageBgView_2];
    self.imageBgView_2 = imageBgView_2;
