...
- (void)initViews{
    ...
    firstImageview.frame = CGRectMake(SPACE_TEN, SPACE_TEN, SCREEN_W - SPACE_TWENTY, RATIO_H(150));
    firstImageview.image = [UIImage imageNamed:@"1.jpg"];
    [self.view addSubview:firstImageview];
    self.firstImageview = firstImageview;
    
    UIImageView *topImageview = [[UIImageView alloc] init];
    topImageview.frame = CGRectMake(SPACE_TEN, SPACE_TEN + 1 * (RATIO_H(150) + SPACE_TEN), SCREEN_W - SPACE_TWENTY, RATIO_H(100));
    topImageview.image = [UIImage imageNamed:@"1.jpg"];
    [self.view addSubview:topImageview];
    self.topImageview = topImageview;
    
    UIImageView *middleImageview = [[UIImageView alloc] init];
    middleImageview.frame = CGRectMake(SPACE_TEN, SPACE_TEN +2 * (RATIO_H(150) + SPACE_TEN), SCREEN_W - SPACE_TWENTY, RATIO_H(100));
    middleImageview.image = [UIImage imageNamed:@"1.jpg"];
    [self.view addSubview:middleImageview];
    self.middleImageview = middleImageview;
    
    UIImageView *bottomImageview = [[UIImageView alloc] init];
    bottomImageview.frame = CGRectMake(SPACE_TEN, SPACE_TEN + 3 * (RATIO_H(150) + SPACE_TEN), SCREEN_W - SPACE_TWENTY, RATIO_H(100));
    bottomImageview.image = [UIImage imageNamed:@"1.jpg"];
...
- (void)nextVC{
    MaskNextViewController *vc = [MaskNextViewController new];
